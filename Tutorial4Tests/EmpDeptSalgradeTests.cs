...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<int> ChicagoDept = depts.Where(d => d.Loc.Equals("CHICAGO")).Select(d => d.DeptNo).ToList();

        List<Emp> result = emps.Where(e => ChicagoDept.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps
            .Where(e => e.Comm != null)
            .SelectMany(e => new[] { new { EName = e.EName, Comm = e.Comm } });
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => 1, s => 1, (e, s) => new { e, s })
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps
            .Where(e => e.Sal > emps.Where(s => s.DeptNo == e.DeptNo).Average(s => s.Sal))
            .Select(e => e.EName); 
